...
set rc [catch {
  ...
  add_files -quiet F:/VivadoWork/Single_CPU/Single_CPU.runs/synth_1/Show.dcp
...
set rc [catch {
  ...
  catch {update_ip_catalog -quiet -current_ip_cache {f:/VivadoWork/Single_CPU/Single_CPU.cache} }
  opt_design 
...
set rc [catch {
  ...
  if { [file exists F:/VivadoWork/Single_CPU/Single_CPU.runs/synth_1/Show.hwdef] } {
    catch { write_sysdef -hwdef F:/VivadoWork/Single_CPU/Single_CPU.runs/synth_1/Show.hwdef -bitfile Show.bit -meminfo Show_bd.bmm -file Show.sysdef }
  }
